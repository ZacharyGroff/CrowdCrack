...
func NewCmdLineConfigProvider() CmdLineConfigProvider {
	clientConfig, serverConfig, isClient := parseCmdLine()
	return CmdLineConfigProvider{clientConfig, serverConfig, isClient}
}

func parseCmdLine() (*models.ClientConfig, *models.ServerConfig, bool) {
	...
	return clientConfig, serverConfig, *isClientPtr
}

func (c *CmdLineConfigProvider) IsClient() bool {
	return c.isClient
}
